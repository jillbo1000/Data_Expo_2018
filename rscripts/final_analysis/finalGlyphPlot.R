...
pdf("../../images/final/poster/glyphFinal.pdf", width = 43.35, height = 11)
...
pdf("../../images/final/poster/glyphFinal2.pdf", width = 20, height = 30)
...
grid.arrange(grobs = list(ggplotGrob(map8.2), ggplotGrob(tglyph.2), 
             ...
             layout_matrix = rbind(c(1,1,1), c(2, 3, 4), c(5, 5, 5), c(6, 6, 6)),
             heights = c(0.39, 0.19, 0.39, 0.03), clip = "off")
dev.off()
