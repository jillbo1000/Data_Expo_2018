...
pdf("../../images/test/AggMap1.pdf", height = 5, width = 11)
grid.arrange(g1, g4, widths = c(2, 4), ncol = 2)
dev.off()

pdf("../../images/test/AggMap2.pdf", height = 5, width = 11)
grid.arrange(g2, g5, widths = c(2, 4), ncol = 2)
dev.off()

pdf("../../images/test/AggMap3.pdf", height = 5, width = 11)
grid.arrange(g3, g6, widths = c(2, 4), ncol = 2)
dev.off()


pdf("../../images/final/Final_Scatters_Portrait.pdf", height = 11, width = 8)
grid.arrange(g1, g4, g2, g5, g3, g6, widths = c(2, 3), ncol = 2)
dev.off()

pdf("../../images/final/Final_Scatters_Landscape.pdf", height = 6, width = 11)
...
pdf("../../images/test/LagP1.pdf", height = 5, width = 11)
...
pdf("../../images/test/LagP2.pdf", height = 5, width = 11)
...
pdf("../../images/test/LagP3.pdf", height = 5, width = 11)
...
pdf("../../images/final/poster/ScatterTop1.pdf", height = 4, width = 11)
grid.draw(cbind(ggplotGrob(lagP1.l5), ggplotGrob(lagP1.l3), ggplotGrob(lagP1.l1), 
                ggplotGrob(dummy), size = "first"))
dev.off()

pdf("../../images/final/poster/ScatterBottom1.pdf", height = 5, width = 11)
grid.arrange(g1, g4, widths = c(2, 4), ncol = 2)
dev.off()

pdf("../../images/final/poster/ScatterTop2.pdf", height = 4, width = 11)
grid.draw(cbind(ggplotGrob(lagP2.l5), ggplotGrob(lagP2.l3), ggplotGrob(lagP2.l1), 
                ggplotGrob(dummy), size = "first"))
dev.off()

pdf("../../images/final/poster/ScatterBottom2.pdf", height = 5, width = 11)
grid.arrange(g2, g5, widths = c(2, 4), ncol = 2)
dev.off()

pdf("../../images/final/poster/ScatterTop3.pdf", height = 4, width = 11)
grid.draw(cbind(ggplotGrob(lagP3.l5), ggplotGrob(lagP3.l3), ggplotGrob(lagP3.l1), 
                ggplotGrob(dummy), size = "first"))
dev.off()

pdf("../../images/final/poster/ScatterBottom3.pdf", height = 5, width = 11)
grid.arrange(g3, g6, widths = c(2, 4), ncol = 2)
dev.off()

pdf("../../images/final/poster/ScatterTopSlides.pdf", height = 4, width = 11)
grid.draw(cbind(ggplotGrob(lagPA.l5), ggplotGrob(lagPA.l3), ggplotGrob(lagPA.l1), 
                ggplotGrob(dummy), size = "first"))
dev.off()

pdf("../../images/final/poster/ScatterBottomSlides.pdf", height = 5, width = 11)
