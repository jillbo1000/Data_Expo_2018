...
pdf("../../images/final/poster/finalPCP.pdf", width =  20, height = 6)
# Grid.draw solution:
# - https://gist.github.com/tomhopper/faa24797bb44addeba79
grid.draw(rbind(ggplotGrob(p2), ggplotGrob(p1), size = "last"))
dev.off()

pdf("../../images/final/poster/finalPCP_Slides.pdf", width =  20, height = 7)
# Grid.draw solution:
# - https://gist.github.com/tomhopper/faa24797bb44addeba79
grid.draw(rbind(ggplotGrob(p2), ggplotGrob(p1), size = "last"))
dev.off()

png("../../images/test/pcptest2.png", width =  14, height = 7, units = "in", res = 300)
# Grid.draw solution:
# - https://gist.github.com/tomhopper/faa24797bb44addeba79
grid.draw(rbind(ggplotGrob(p2), ggplotGrob(p1), size = "last"))
dev.off()
...
pdf("../../images/test/pcptest2.pdf", width =  20, height = 5)
# Grid.draw solution:
# - https://gist.github.com/tomhopper/faa24797bb44addeba79
grid.draw(rbind(ggplotGrob(p2), ggplotGrob(p1), size = "last"))
dev.off()
