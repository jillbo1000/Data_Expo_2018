...
euc <- fastClust(cc2, distType = "euclidean", graphName = "../images/Dendro_Euc_Scaled.pdf")
fastClust(cc2, distType = "maximum", graphName = "../images/Dendro_Max_Scaled2.pdf")
fastClust(cc2, distType = "manhattan", graphName = "../images/Dendro_Man_Scaled2.pdf")
fastClust(cc2, distType = "canberra", graphName = "../images/Dendro_Can_Scaled2.pdf")
fastClust(cc2, distType = "minkowski", graphName = "../images/Dendro_Mink_Scaled2.pdf")
