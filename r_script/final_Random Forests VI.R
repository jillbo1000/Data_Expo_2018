...
pdf("../images/Random Forest VI Plots/Six Clusters.pdf", width = 17, height = 11)
par(mfrow = c(3, 3))
for(i in 1:6) {
...
pdf("../images/Random Forest VI Plots/VI Parallel Coordinate Plot2.pdf", height = 6.5, width = 25)
gmax
dev.off()
...
pdf("../images/final/finalImportance_Paper.pdf", height = 6, width = 10)
gmax2
dev.off()
...
pdf("../images/Random Forest VI Plots/Dot Plots Max 5.3.pdf", width = 15, height = 10)
...
pdf("../images/Random Forest VI Plots/Dot Plots Max 4.3.pdf", width = 15, height = 10)
...
pdf("../images/Random Forest VI Plots/Dot Plots Max 3.3.pdf", width = 15, height = 10)
