# Test script for point-based micromaps... (I hope they work)
...
pdf("../images/pointMicroTest.pdf", height = 15, width = 10)
...
pdf("../images/pointMicroTest2.pdf", height = 15, width = 10)
...
pdf("../images/pointMicroTest3.pdf", height = 15, width = 10)
...
pdf("../images/pointMicroTest4.pdf", height = 15, width = 10)
...
#==============================================================================
cluster2 = read.csv("../Data/History/Data Versions as of 6-21-2018/Combined_for_Clustering_Bean.csv")
colnames(cluster2)
summary(cluster2)
...
city = read.csv("../Data/History/Data Versions as of 6-21-2018/locationsFinal.csv") %>%
...
cluster = read.csv("../Data/History/Data Versions as of 6-21-2018/Combined_for_Clustering.csv") %>%
...
precips <- read.csv("../Data/History/Data Versions as of 6-21-2018/PrecipErrors.csv")
