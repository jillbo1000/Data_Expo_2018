...
cc2 <- cluster2 %>% dplyr::select(-AirPtCd, -city, -state, -longitude, -latitude,
                                  ...
                                  -BSS, -Cluster6, -color, -name, -ClustName, -Cluster)
...
png("../images/mapTrial1.png", width = 14, height = 10, units = "in", res = 300)
...
pdf("../images/final/finalMap_Slides.pdf", width = 14, height = 10)
